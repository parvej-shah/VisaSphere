      ...
      >
        {slides.map((slide, index) => (
          <SwiperSlide key={index} className='relative'>
            <div className='bg-gradient-to-b from-black/60 to-transparent w-full h-full'>
            <img
              src={slide.image}
              alt={`Slide ${index + 1}`}
            ...
            />
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center px-4">
                ...
                <button onClick={()=>navigate('/all-visas')} className="btn bg-secondary border-none text-gray-700 font-bold px-6 py-3 transition-all transform duration-500 rounded-lg hover:bg-primary hover:text-gray-50 flex items-center gap-2">
